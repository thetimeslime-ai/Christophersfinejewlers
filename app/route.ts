  ...
  <section class="relative overflow-hidden grain" style="padding-top: 72px; min-height: 100vh; display: flex; align-items: center; background: #1a1a1a;">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-8 w-full">
      <div class="max-w-xl">
        ...
        <p class="fade-up text-gold-400 font-sans mb-6 hero-tagline" style="font-size:0.68rem; letter-spacing:0.28em; text-transform:uppercase;">Est. Houston, Texas</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div>
          ...
          <div style="display:flex; gap:10px; margin-top:20px;">
            <a href="https://www.instagram.com/christophersfinejewelers" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
               style="display:flex; align-items:center; justify-content:center; width:36px; height:36px; border-radius:50%; background:rgba(255,255,255,0.07); border:1px solid rgba(255,255,255,0.12); transition:background 0.25s ease, border-color 0.25s ease;"
               onmouseenter="this.style.background='rgba(225,48,108,0.22)'; this.style.borderColor='rgba(225,48,108,0.45)';"
               onmouseleave="this.style.background='rgba(255,255,255,0.07)'; this.style.borderColor='rgba(255,255,255,0.12)';">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="rgba(255,255,255,0.65)" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <a href="https://www.thumbtack.com/ca/roseville/handmade-jewelry/christophers-fine-jewelers/service/562173046186352640" target="_blank" rel="noopener noreferrer" aria-label="Thumbtack"
               style="display:flex; align-items:center; justify-content:center; width:36px; height:36px; border-radius:50%; background:rgba(255,255,255,0.07); border:1px solid rgba(255,255,255,0.12); transition:background 0.25s ease, border-color 0.25s ease;"
               onmouseenter="this.style.background='rgba(0,159,217,0.22)'; this.style.borderColor='rgba(0,159,217,0.45)';"
               onmouseleave="this.style.background='rgba(255,255,255,0.07)'; this.style.borderColor='rgba(255,255,255,0.12)';">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="rgba(255,255,255,0.65)" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M13.3913 13.3478L14.4348 19.1304H9.5652L10.6087 13.3478C8.6087 12.6522 7.1304 10.7826 7.1304 8.6087C7.1304 5.8696 9.2609 3.6522 12 3.6522C14.7391 3.6522 16.8696 5.8696 16.8696 8.6087C16.8696 10.7826 15.3913 12.6522 13.3913 13.3478Z"/>
              </svg>
            </a>
          </div>
        </div>
